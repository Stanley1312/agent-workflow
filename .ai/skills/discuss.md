...
**Edge case questions** — find the gaps
...
**Scope questions** — define the boundary
...
- ❌ Moving forward before the synthesis is confirmed
- ❌ Treating the first answer as the final answer on complex topics

## Usage
```
/discuss I want to add real-time notifications to the app
/discuss should we use PostgreSQL or MongoDB for this feature
/discuss the current auth flow feels too complex for users
```
